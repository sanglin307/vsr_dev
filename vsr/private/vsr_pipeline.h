...
struct VkPipelineLayout_T : public vsrDeviceResource, public MemoryAlloc<VkPipelineLayout_T, VK_SYSTEM_ALLOCATION_SCOPE_OBJECT> {
...
struct VkPipelineCache_T : public vsrDeviceResource, public MemoryAlloc<VkPipelineCache_T, VK_SYSTEM_ALLOCATION_SCOPE_CACHE> {
...
struct VkPipeline_T : public vsrDeviceResource, public MemoryAlloc<VkPipeline_T, VK_SYSTEM_ALLOCATION_SCOPE_OBJECT> {
